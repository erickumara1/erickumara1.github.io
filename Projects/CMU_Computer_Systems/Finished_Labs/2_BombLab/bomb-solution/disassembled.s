...
0000000000400efc <phase_2>:
  ...
  //rsp has to equal 1, so the first element is 1
...
------------------------------
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax // rax equal to rsp + 12
  400fc2:	74 05                	je     400fc9 <phase_3+0x86>
  400fc4:	e8 71 04 00 00       	call   40143a <explode_bomb>
  400fc9:	48 83 c4 18          	add    $0x18,%rsp
  400fcd:	c3                   	ret

0000000000400fce <func4>: //rdx = 14, rsi = 0, rdi = rsp + 8
  400fce:	48 83 ec 08          	sub    $0x8,%rsp // 8 bytes
  400fd2:	89 d0                	mov    %edx,%eax // rax = rdx = 14
  400fd4:	29 f0                	sub    %esi,%eax // rax -= rsi
  400fd6:	89 c1                	mov    %eax,%ecx // rcx = rax
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx // shift rcx 31 to the right
  400fdb:	01 c8                	add    %ecx,%eax //rax += rcx
  400fdd:	d1 f8                	sar    $1,%eax //shift rax 1 to the right
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx //rax + rsi = rcx
  400fe2:	39 f9                	cmp    %edi,%ecx //if rdi <= rcx, rcx is 7 and rdi is 3 for run 1, rcx is 3 and rdi is 3 for run 2
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24> 

  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx //rdx = rcx - 1 and rcx > rdx
  400fe9:	e8 e0 ff ff ff       	call   400fce <func4> //if rcx > rdi
  // after run 1 rdx is 6, rsi is 0 and rdi is 3
  400fee:	01 c0                	add    %eax,%eax // rax += rax
  400ff0:	eb 15                	jmp    401007 <func4+0x39>

  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax //rax = 0
  400ff7:	39 f9                	cmp    %edi,%ecx //compare rcx and rdi 
  400ff9:	7d 0c                	jge    401007 <func4+0x39> //if rdi greater than rcx

  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi //rsi = rcx + 1
  400ffe:	e8 cb ff ff ff       	call   400fce <func4> // goes back to top 
...
000000000040100c <phase_4>:
  40100c:	48 83 ec 18          	sub    $0x18,%rsp // 24 bytes subtracted
  401010:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx // rcx = rsp + 12
  401015:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx // rdx = rsp + 8
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi //rsi is d d
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax
  401024:	e8 c7 fb ff ff       	call   400bf0 <__isoc99_sscanf@plt>
  401029:	83 f8 02             	cmp    $0x2,%eax //input has to be 2 
  40102c:	75 07                	jne    401035 <phase_4+0x29>
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp) //rsp + 8 is less than or equal to 14
  ...
  40104d:	85 c0                	test   %eax,%eax //rax has to be 0
  40104f:	75 07                	jne    401058 <phase_4+0x4c>
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp) //compares 0 and rsp + 12
  401056:	74 05                	je     40105d <phase_4+0x51> // if rsp + 12 equal to 0 then it passes
  401058:	e8 dd 03 00 00       	call   40143a <explode_bomb>
  40105d:	48 83 c4 18          	add    $0x18,%rsp
  401061:	c3                   	ret

0000000000401062 <phase_5>:
  401062:	53                   	push   %rbx //rbx on stack
  401063:	48 83 ec 20          	sub    $0x20,%rsp //32 bytes worth of rsp
  401067:	48 89 fb             	mov    %rdi,%rbx //rbx = rdi
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax //rax = fs + 40, fs is  register
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp) //rsp+24 = rax
  401078:	31 c0                	xor    %eax,%eax //rax = 0
  40107a:	e8 9c 02 00 00       	call   40131b <string_length>
  40107f:	83 f8 06             	cmp    $0x6,%eax // input length of 6
...
//stores 16 + rsp to 22 + rsp the last 8 bit of rdx
  ...
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp) // 0 = rsp + 22
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi // rsi = $0x40245e, rsi = flyers
...
000000000040145c <read_six_numbers>:
  40145c:	48 83 ec 18          	sub    $0x18,%rsp // rsp = rsp - 3 bytes
  401460:	48 89 f2             	mov    %rsi,%rdx // rdx = rsi
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx // rcx = rsi + 0.5 bytes
  ...
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8 // r8 = rsi + 1 bytes
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi // rsi = d d d d d d 
  401485:	b8 00 00 00 00       	mov    $0x0,%eax // rax = 0
  40148a:	e8 61 f7 ff ff       	call   400bf0 <__isoc99_sscanf@plt>
  40148f:	83 f8 05             	cmp    $0x5,%eax // skips bomb if rax > 5
